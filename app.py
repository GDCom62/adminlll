...
# Função para gerar PDF com larguras corrigidas e completadas na linha 43
def gerar_pdf(acoes):
    buffer = io.BytesIO()
    ...
    # CORREÇÃO CRÍTICA: Valores de larguras inseridos para impedir o travamento da página
