...
# Buscar dados iniciais do banco Supabase de forma protegida para alimentar os filtros
acoes_base = []
try:
    supabase = get_supabase_client()
...
# --- CORREÇÃO DO FLUXO: PAINEL OPERACIONAL INVERTIDO NO TOPO DO CODIGO ---
# Colocar o processamento dos botões ANTES da leitura final da tabela garante a atualização imediata
st.write("---")
...
# PROCESSAMENTO DOS BOTÕES DE SALVAMENTO (AGORA NO LUGAR CORRETO)
if st.session_state['edit_item']:
...
# ==============================================================================
# LEITURA ATUALIZADA DO BANCO E EXIBIÇÃO DE DADOS (APÓS ENVIOS)
# ==============================================================================

# Buscar dados definitivos pós-gravação
acoes = []
try:
    supabase = get_supabase_client()
...
# Aplicar filtros avançados da Sidebar nos dados atualizados
